...
from django_facebook.views import connect,disconnect,example
from django_facebook.example_views import lazy_decorator_example,decorator_example,decorator_example_scope,wall_post,checkins,image_upload,canvas,page_tab,open_graph_beta,remove_og_share
...
url(r'^decorator_example_scope/$', decorator_example_scope,name='facebook_decorator_example_scope'),
url(r'^wall_post/$',wall_post, name='facebook_wall_post'),
url(r'^checkins/$',checkins, name='facebook_checkins'),
